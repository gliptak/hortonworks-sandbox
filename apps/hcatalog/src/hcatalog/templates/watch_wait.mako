...
${commonheader(_('HCatalog: Waiting for query...'), "hcatalog", user, "100px")}
${layout.menubar(section='tables')}

<meta http-equiv="refresh" content="3;${url('hcatalog.views.watch_query', query.id)}?${fwd_params}" />

<div class="container-fluid">
	<h1>${_('HCatalog: Waiting for query...')} ${util.render_query_context(query_context)}</h1>
	<div class="row-fluid">
		<div class="span3">
