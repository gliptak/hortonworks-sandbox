...
${commonheader(_("HCatalog: Create table manually"), "hcatalog", user, "100px")}
...
<div class="form-actions">
    ...
    <input id="submit" type="submit" class="btn primary hide" name="createTable" value="${_('Create table')}" />
</div>
</form>
</div>
</div>
