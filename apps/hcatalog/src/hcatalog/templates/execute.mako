...
<%def name="query()">
    ...
    <fieldset>
      ...
      <div class="clearfix">
        <div class="input">
            <textarea class="span9" rows="9" placeholder="${_('Example: SELECT * FROM tablename')}" name="${form.query["query"].html_name | n}" id="queryField">${extract_field_data(form.query["query"]) or table}</textarea>
